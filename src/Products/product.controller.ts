...
@ApiOperation({
  ...
  description: 'Este endpoint permite obtener todos los productos con paginación. El número de página y el límite de productos por página pueden ser configurados mediante parámetros de consulta.',
})
...
@ApiOperation({
  ...
  description: 'Este endpoint permite obtener los detalles de un producto específico utilizando su ID. El ID debe ser un UUID válido.',
})
...
@ApiOperation({
  ...
  description: 'Este endpoint permite editar los detalles de un producto específico utilizando su ID. El ID debe ser un UUID válido y el cuerpo de la solicitud debe contener los datos actualizados del producto.',
})
@ApiBearerAuth()
async editProduct(
  @Param('id', ParseUUIDPipe) id: string,

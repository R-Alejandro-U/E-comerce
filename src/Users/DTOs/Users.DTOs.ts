...
class CreateUserDTO {
  ...
  @ApiProperty({description: "Debe contener un email valido", example: "example.123@gmail.com"})
  email: string;
  ...
  @ApiProperty({description: "Debe contener un nombre, con un minimo de 3 caracteres y un maximo de 80", example: "pepe"})
  name: string;
  ...
  @ApiProperty({description: "Debe contener una contraseña fuerte, con un minimo de 8 caracteres y un maximo de 15. La contraseña debe incluir al menos 1 mayúscula, 1 minúscula, 1 número y 1 símbolo.", example: "Pepe*1234"})
  password: string;
  ...
  @ApiProperty({description: "Debe contener la misma contraseña que el input contraseña", example: "Pepe*1234"})
  ...
  @ApiProperty({description: "Debe contener una dirección, con un minimo de 3 caracteres y un maximo de 80", example: "Av. pepe 12345"})
  address: string;
  ...
  @ApiProperty({description: "Debe contener un numero de telefono valido con el codigo regional del pais", example: "+541123456789"})
  phone: string;
  ...
  @ApiProperty({description: "Este campo es opcional, si se agrega debe contener un pais con un maximo de 20 caractres y un minimo de 5", example: "Venezuela", default: undefined})
  country?: string;
  ...
  @ApiProperty({description: "Este campo es opcional, si se agrega debe contener una ciudad con un maximo de 20 caractres y un minimo de 5", example: "Maracaibo", default: undefined})
  city?: string;

  @IsEmpty({message: "Este campo no puedo ser recibido por parametro."})
  @ApiProperty({description: "Este campo no es requerido, y por defecto es falso", default: false, readOnly: true})
  isAdmin?: boolean;
}
...
class UserDTOResponse2 {
  ...
  @ApiProperty({
    description: 'Indica si el usuario tiene permisos de administrador. Este campo no es aceptado. Por defecto es false.',
    example: false,
    default: false,
    readOnly: true
  })
...
class UserDTOResponse3 {
  ...
  @ApiProperty({description: 'Lista de Ordenes del usuario.', type: [UserOrderDTO]})
  orders?: UserOrderDTO[];
}
...
class UserUpdateDTO {
  ...
  @ApiProperty({
    description: 'El identificador único del usuario. Este campo no puede ser modificado.',
  ...
  @ApiProperty({
    description: 'Número de teléfono en formato internacional, incluyendo el código de país.',
